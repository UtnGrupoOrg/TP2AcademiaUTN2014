        ...
        <ContentTemplate>
            ...
            <asp:Panel CssClass="centered" ID="formPanel" runat="server" Visible="false">
                ...
                <br />       
                    ...
                    <asp:LinkButton ID="lbtnAceptar" runat="server" Text="Button" CausesValidation="true" OnClick="lbtnAceptar_Click" >Aceptar</asp:LinkButton>
                    <asp:LinkButton ID="lbtnCancelar" runat="server" CausesValidation="false" Text="Button" OnClick="lbtnCancelar_Click">Cancelar</asp:LinkButton>
                </asp:Panel>
            </asp:Panel>
        </ContentTemplate>
     </asp:UpdatePanel>
